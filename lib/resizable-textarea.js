(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ResizableTextArea"] = factory();
	else
		root["ResizableTextArea"] = factory();
})(window, function() {
...
var _flattenNames = __webpack_require__(90);

var _flattenNames2 = _interopRequireDefault(_flattenNames);

var _mergeClasses = __webpack_require__(161);
...
var _hover2 = __webpack_require__(182);

var _hover3 = _interopRequireDefault(_hover2);

var _active = __webpack_require__(183);

var _active2 = _interopRequireDefault(_active);

var _loop2 = __webpack_require__(184);
...
var _EditableInput = __webpack_require__(188);
...
var _Raised = __webpack_require__(191);
...
var _ColorWrap = __webpack_require__(81);
...
var _checkboard = __webpack_require__(187);
...
var _Alpha = __webpack_require__(89);
...
var k=__webpack_require__(47),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.concurrent_mode"):60111,y=n?Symbol.for("react.forward_ref"):60112,z=n?Symbol.for("react.suspense"):60113,aa=n?Symbol.for("react.memo"):
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(47),r=__webpack_require__(87);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _materialColors = __webpack_require__(82);
...
// CONCATENATED MODULE: ./src/utils/calculateFontSize.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var calculateFontSize_FontSizeCalc =
/*#__PURE__*/
function () {
  function FontSizeCalc() {
    _classCallCheck(this, FontSizeCalc);
  ...
  _createClass(FontSizeCalc, [{
    ...
    key: "getCalculatedTop",
    value: function getCalculatedTop(top, height) {
      return Math.min(top >= 0 ? top : 0, this.maxH - height < 0 ? 0 : this.maxH - height);
    }
  }, {
    key: "getCalculatedBottom",
    value: function getCalculatedBottom(bottom, height) {
      return Math.min(bottom >= 0 ? bottom : 0, this.maxH - height < 0 ? 0 : this.maxH - height);
    }
  }, {
    key: "getCalculatedLeft",
    value: function getCalculatedLeft(left, width) {
      return Math.min(left >= 0 ? left : 0, this.maxW - width < 0 ? 0 : this.maxW - width);
    }
  }, {
    key: "getCalculatedRight",
    value: function getCalculatedRight(right, width) {
      return Math.min(right >= 0 ? right : 0, this.maxW - width < 0 ? 0 : this.maxW - width);
    }
  }, {
    key: "getPosWithFont",
    value: function getPosWithFont(_ref) {
      var size = _ref.size,
          top = _ref.top,
          left = _ref.left,
          text = _ref.text,
      ...
      var obj = this.getTotalHeightWidth(size, family, text, maxWidth, maxHeight, lineHeight, width, height);

      if (obj.scrollWidth * obj.scrollHeight <= maxWidth * maxHeight) {
        var remainingLeft = maxWidth - obj.scrollWidth;
        var remainingTop = maxHeight - obj.scrollHeight;
        var calculatedLeft = Math.min(left, remainingLeft);
        var calculatedTop = Math.min(top, remainingTop);
    ...
    key: "getTotalHeightWidth",
    value: function getTotalHeightWidth(size, family, text, maxWidth, maxHeight, lineHeight, width, height) {
      this.el = document.getElementById("dummyContainer");
    ...
    value: function getCalculatedWidth(width) {
      return this.maxW < width ? this.maxW : width;
    }
  }, {
    key: "getCalculatedHeight",
    value: function getCalculatedHeight(height) {
      return this.maxH < height ? this.maxH : height;
    }
  }, {
    key: "getCalculatedStyle",
    value: function getCalculatedStyle(style, newObj) {
      var newWidth = this.getCalculatedWidth(newObj.width);
      var newHeight = this.getCalculatedHeight(newObj.height);
      return {
        width: newWidth,
        height: newHeight
      };
...
/* harmony default export */ var calculateFontSize = (new calculateFontSize_FontSizeCalc());
...
var utils_calculateFontSize = function calculateFontSize(text, maxLength) {
  var initial = 14;
  var totalTextSize = initial * text.length / 2;
  var lines = maxLength < totalTextSize ? Math.floor(totalTextSize / maxLength) : 1; // fontFactor = initial / (lines > 1 ? maxLength : totalTextSize);
...
var calculateDimension = function calculateDimension(text, maxLength, initial) {
  var lineArray = text.split("\n");

  if (lineArray.length === 1) {
    var _totalTextSize = initial * text.length / 2;

    var _lines = maxLength < _totalTextSize ? Math.floor(_totalTextSize / maxLength) : 1; // fontFactor = initial / (lines > 1 ? maxLength : totalTextSize);


    return {
      width: _lines > 1 ? maxLength : _totalTextSize,
      height: _lines * initial,
      fontSize: initial
    };
  }

  var highest = lineArray.reduce(function (acc, val) {
    return val.length > acc.length ? val : acc;
  }, lineArray[0]);
  var totalTextSize = initial * highest.length / 2;
  var lines = maxLength < totalTextSize ? Math.floor(totalTextSize / maxLength) : 1;
  var finalLines = lines + lineArray.length - 1; // fontFactor = initial / (finalLines > 1 ? maxLength : totalTextSize);
...
var getFontSize = function getFontSize(newWidth, fontFactor) {
  return Math.floor(newWidth * fontFactor);
};
var mapResizer = {
  a: {
    key: "a",
    ...
    getCalculatedPosition: function getCalculatedPosition(newDimension, style) {
      return _objectSpread({}, style, newDimension, {
        bottom: calculateFontSize.getCalculatedBottom(style.bottom, newDimension.height),
        right: calculateFontSize.getCalculatedRight(style.right, newDimension.width)
      });
    },
    getDimension: function getDimension(_ref) {
      var width = _ref.width,
          height = _ref.height,
  ...
  b: {
    ...
    getCalculatedPosition: function getCalculatedPosition(newDimension, style) {
      return _objectSpread({}, style, newDimension, {
        bottom: calculateFontSize.getCalculatedBottom(style.bottom, newDimension.height),
        left: calculateFontSize.getCalculatedLeft(style.left, newDimension.width)
      });
    },
    getStyle: function getStyle(style) {
      return {
    ...
    getDimension: function getDimension(_ref2) {
  ...
  c: {
    ...
    getCalculatedPosition: function getCalculatedPosition(newDimension, style) {
      return _objectSpread({}, style, newDimension, {
        top: calculateFontSize.getCalculatedTop(style.top, newDimension.height),
        right: calculateFontSize.getCalculatedRight(style.right, newDimension.width)
      });
    },
    getStyle: function getStyle(style) {
    ...
    getDimension: function getDimension(_ref3) {
  ...
  d: {
    ...
    getDimension: function getDimension(_ref4) {
  ...
  e: {
    ...
    getDimension: function getDimension(_ref5) {
  ...
  f: {
    ...
    getDimension: function getDimension(_ref6) {
...
// EXTERNAL MODULE: ./src/component/helperComponent/fakeComponent/index.css
var fakeComponent = __webpack_require__(253);

// CONCATENATED MODULE: ./src/component/helperComponent/fakeComponent/index.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function fakeComponent_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function fakeComponent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function fakeComponent_createClass(Constructor, protoProps, staticProps) { if (protoProps) fakeComponent_defineProperties(Constructor.prototype, protoProps); if (staticProps) fakeComponent_defineProperties(Constructor, staticProps); return Constructor; }
...
var fakeComponent_FakeComponent =
/*#__PURE__*/
function (_React$Component) {
  ...
  function FakeComponent(props) {
    ...
    fakeComponent_classCallCheck(this, FakeComponent);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FakeComponent).call(this, props));
    _this.mousePosition = {
      x: 0,
      y: 0
    };
    ...
    _this.resize = function (e) {
      if (_this.dragging) {
        _this.props.dragging(e.pageX - _this.mousePosition.x, e.pageY - _this.mousePosition.y);
      ...
      _this.props.onResize({
        ...
        previous: {
          pageX: _this.mousePosition.x,
          pageY: _this.mousePosition.y
        }
      });
    };
  ...
  fakeComponent_createClass(FakeComponent, [{
    key: "addResizeEvent",
    value: function addResizeEvent() {
      var _this2 = this;

      window.addEventListener('mouseup', function () {
        return _this2.removeResizeEvent();
      });
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        onDoubleClick: function onDoubleClick() {
          return _this3.props.enableEditMode();
        }
      ...
      }, Object.keys(mapResizer).map(function (key) {
        return react_default.a.createElement("div", {
          key: key,
          className: "resizer ".concat(mapResizer[key].name),
          onMouseDown: function onMouseDown(e) {
            _this3.isMouseDown = true;

            _this3.mouseDown(e);

            _this3.props.resizeClicked(key);
          }
        });
      })));
    }
...
// CONCATENATED MODULE: ./src/component/helperComponent/index.js

/* harmony default export */ var helperComponent = ({
  FakeComponent: fakeComponent_FakeComponent
});
// CONCATENATED MODULE: ./src/utils/cursor.js
var setCursorToEnd = function setCursorToEnd(el) {
...
// EXTERNAL MODULE: ./src/component/index.css
var component = __webpack_require__(254);
...
var component_RichTextInput =
/*#__PURE__*/
function (_React$Component) {
  component_inherits(RichTextInput, _React$Component);

  function RichTextInput(props) {
    var _this;

    component_classCallCheck(this, RichTextInput);

    _this = component_possibleConstructorReturn(this, component_getPrototypeOf(RichTextInput).call(this, props));
    _this.myRef = react_default.a.createRef(); //SyntheticEvent<window>

    calculateFontSize.setMaxValues(_this.props.maxWidth, _this.props.maxHeight);
  ...
  component_createClass(RichTextInput, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _fontSizeCalc$getPosW = calculateFontSize.getPosWithFont({
        ...
        width: this.props.width
          ...
          top = _fontSizeCalc$getPosW.top,
          left = _fontSizeCalc$getPosW.left,
          right = _fontSizeCalc$getPosW.right,
          bottom = _fontSizeCalc$getPosW.bottom,
          width = _fontSizeCalc$getPosW.width,
          height = _fontSizeCalc$getPosW.height,
          size = _fontSizeCalc$getPosW.size;
    ...
    value: function adjustContainer() {
      ...
      var style = mapResizer.d.getCalculatedPosition({
      ...
      this.setState({
        ...
        var node = _this2.myRef.current.cloneNode();

        var childNode = _this2.myRef.current.querySelector(".contentEditable").cloneNode(true);

        childNode.contentEditable = false;
        node.appendChild(childNode);

        _this2.props.getHTML(node.outerHTML);
      });
    }
  }, {
    key: "setPropertyOnMouseDown",
    value: function setPropertyOnMouseDown() {
      this.oldTopLeft = {
    ...
    key: "focustAtSpecific",
    value: function focustAtSpecific() {
    ...
    key: "showColorOptionsIfNeeded",
    value: function showColorOptionsIfNeeded() {
      this.setSelection();
      this.setState({
    ...
    value: function componentDidUpdate() {
      ...
      var childElement = this.myRef.current.querySelector(".contentEditable").outerHTML;
      this.props.getHTML("<div style=\"".concat(this.myRef.current.style.cssText, "\">").concat(childElement, "</div>"));
    }
  }, {
    key: "renderContentEditable",
    value: function renderContentEditable() {
      var _this3 = this;

      return react_default.a.createElement("div", {
        className: "contentEditable",
        contentEditable: true // onInput={this.emitChange} 
        ,
        onBlur: function onBlur() {
          var childElement = _this3.myRef.current.querySelector(".contentEditable").outerHTML;

          _this3.props.getHTML("<div style=\"".concat(_this3.myRef.current.style.cssText, "\">").concat(childElement, "</div>"));

          _this3.focustAtSpecific();
        },
        onMouseUp: function onMouseUp() {
          setTimeout(function () {
            _this3.showColorOptionsIfNeeded();
          }, 0);
        },
        ...
        onKeyDown: function onKeyDown(e) {
          if (_this3.props.maxHeight <= e.currentTarget.scrollHeight) {
            _this3.setState({
              fontSize: _this3.state.fontSize - 1,
              fontFactor: (_this3.state.fontSize - 1) / _this3.state.style.width
            });
          }
        },
    ...
    key: "getFontSize",
    value: function getFontSize(width, height) {
      return this.props.maxHeight > height && this.props.maxWidth > width;
    }
  }, {
    key: "renderColorOption",
    value: function renderColorOption() {
      var _this4 = this;

      return [this.state.showColors && (this.state.openColorPicker || this.state.openBackColorPicker) ? react_default.a.createElement(lib["SketchPicker"], {
        color: this.state.openBackColorPicker ? this.state.backcolor : this.state.color,
        onChangeComplete: function onChangeComplete(color) {
          if (_this4.state.openBackColorPicker) {
            if (window.getSelection().isCollapsed) {
              _this4.focustAtSpecific();
            } else {
              _this4.setSelection();
            }
      ...
      }) : null, this.state.showColors ? react_default.a.createElement("div", {
        ...
        onClick: function onClick(e) {
          ...
          _this4.focustAtSpecific(); // $FlowFixMe


          _this4.setState({
            openBackColorPicker: true,
            openColorPicker: false,
    ...
    key: "renderLimitContainer",
    value: function renderLimitContainer() {
      var _this5 = this;
      ...
      return react_default.a.createElement("div", {
        ...
        style: component_objectSpread({}, this.state.resizing ? this.state.resizing.getStyle(this.state.style) : {
      ...
      }, this.renderColorOption(), this.renderContentEditable(), !this.state.editMode ? react_default.a.createElement(helperComponent.FakeComponent, {
        enableEditMode: function enableEditMode() {
          !_this5.state.editMode && _this5.setState({
            editMode: true
          }, function () {
            setCursorToEnd(_this5.myRef.current.querySelector(".contentEditable"));
          });
        },
        updatePosition: function updatePosition() {
          _this5.setState({
            style: component_objectSpread({}, _this5.state.style, _this5.updatePosition())
          }, function () {
            return _this5.setPropertyOnMouseDown();
          });
        },
        resizeClicked: function resizeClicked(type) {
          _this5.setState({
        ...
        resetResized: function resetResized() {
          if (!_this5.state.editMode) {
            _this5.setState({
              resizing: null,
              style: component_objectSpread({}, _this5.state.style, _this5.updatePosition())
            });
        ...
        dragging: function dragging(x, y) {
          _this5.setState({
            style: component_objectSpread({}, _this5.state.style, {
              top: calculateFontSize.getCalculatedTop(_this5.oldTopLeft.top + y, getHeight(_this5.myRef.current)),
              left: calculateFontSize.getCalculatedLeft(_this5.oldTopLeft.left + x, getWidth(_this5.myRef.current))
            })
          });
        },
        onResize: function onResize(_ref) {
          var current = _ref.current,
              previous = _ref.previous;
          if (!_this5.state.resizing) return;
          var getCalculatedPosition = _this5.state.resizing.getCalculatedPosition;

          var dimension = _this5.state.resizing.getDimension(component_objectSpread({}, _this5.oldTopLeft, {
            current: current,
            previous: previous,
            height: _this5.state.resizing && (_this5.state.resizing.key === "e" || _this5.state.resizing.key === "f") ? getHeight(_this5.myRef.current) : _this5.oldTopLeft.height
          }));

          if (_this5.myRef.current.scrollHeight > _this5.myRef.current.offsetHeight + 5 && dimension.width < _this5.state.style.width && dimension.width > _this5.state.style.width) {
            return;
          }

          if (_this5.state.resizing && (_this5.state.resizing.key === "e" || _this5.state.resizing.key === "f") && dimension.width < _this5.state.style.width && _this5.props.maxHeight - dimension.height <= _this5.state.fontSize) {
            return;
          }

          if (_this5.state.resizing && (_this5.state.resizing.key === "e" || _this5.state.resizing.key === "f") && dimension.width < _this5.state.style.width && _this5.myRef.current.offsetWidth + 6 < _this5.myRef.current.scrollWidth) {
            return;
          }

          var newDimension = calculateFontSize.getCalculatedStyle(_this5.state.style, dimension);
          var newFont = _this5.state.resizing && _this5.state.resizing.key !== "e" && _this5.state.resizing.key !== "f" ? newDimension.width * _this5.state.fontFactor : _this5.state.fontSize;
          if (_this5.state.resizing && _this5.state.resizing.key !== "e" && _this5.state.resizing.key !== "f" && _this5.state.fontSize < newFont && Math.ceil(getHeight(_this5.myRef.current)) >= _this5.props.maxHeight) return;
          if (newFont < 14) return;
          var style = getCalculatedPosition(newDimension, _this5.state.style);

          _this5.setState({
            fontSize: newFont,
            fontFactor: _this5.state.resizing && (_this5.state.resizing.key === "e" || _this5.state.resizing.key === "f") ? newFont / newDimension.width : _this5.state.fontFactor,
            style: style
          });
        }
      }) : null));
...
/* harmony default export */ var src_component = (function (props) {
  var mergedProps = component_objectSpread({
    maxHeight: 360,
    maxWidth: 640,
    fontSize: 18,
    fontFamily: "Freshman",
  ...
  }, react_default.a.createElement(component_RichTextInput, mergedProps), react_default.a.createElement("div", {
    contentEditable: true,
    id: "dummyContainer"
  }));
});
// CONCATENATED MODULE: ./src/example/index.js
...
var html = 'This is test messag with some random wor<span style="background-color: rgb(175, 81, 81);"><font color="#7ed321">ds jakjkj akja kjjkk kjak jkak kjkjjk</font></span> jka kja kkj kjkj ak kja';
var app = document.getElementById("app");
var node = document.createElement("div");

if (app) {
  setTimeout(function () {
    react_dom_default.a.render(react_default.a.createElement(src_component, {
      text: html,
      width: 329,
      fontSize: 21.7,
      top: 11,
      left: 44,
      getHTML: function getHTML(html) {
        node.innerHTML = html;
...
//# sourceMappingURL=react-resizable-textarea.js.map